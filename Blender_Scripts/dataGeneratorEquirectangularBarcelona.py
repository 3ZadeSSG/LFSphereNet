...
'''
DEFAULT_ROOT = 'barcelona'
SCENE_NAME = "barcelona_midday"
CAMERA_NAME = 'Camera'
SCENE_KEY = '1- time: midday'
SAMPLING = 2000
X_MIN, X_MAX = 2.5, -2.0
Y_MIN, Y_MAX = 0.4, -4.0
Z_MIN, Z_MAX = 0.5, 2.0
...
num_scenes = 10  # Numer of random points where camera grid will be placed in scene
...
if __name__ == '__main__':
    ...
    x_min_list = [10.0,  -8.0,    -5.0,   -5.0,   -3.0,    2.0, -5.0,  -5.0, -15.0, -15.0]
    y_min_list = [-1.0, -11.0,   -11.0,  -11.0,  -11.0,  -11.0, -5.0,  -5.0,  -5.0, -11.0]
    z_min_list = [2.4,    2.4,     2.4,    5.0,    2.4,    2.4,  2.4,   5.0,   2.4,  2.4]
